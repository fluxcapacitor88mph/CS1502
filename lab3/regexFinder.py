...
# The program should read input from a fie that is specifed as the first com-
...
#	have specific meanings in the regular expressions. See below for more on the format
#	of regular expressions. (Note: in PA1 and PA2, the space character could be in the
#	alphabet of the language, but here for this assignment we disallow it. This is so
#	that spaces can be put into regular expressions, to improve readability, without being
#	treated as symbols.)
